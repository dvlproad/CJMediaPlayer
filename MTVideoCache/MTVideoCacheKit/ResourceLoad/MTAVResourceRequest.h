...
typedef NS_ENUM(NSUInteger, MTAVResourceRequestStatus) {
    MTAVResourceRequestStatus_initd,
    MTAVResourceRequestStatus_Loading,
    MTAVResourceRequestStatus_Cancel,
    MTAVResourceRequestStatus_Finish,
};



@interface MTAVResourceRequest : NSObject


@property(nonatomic, assign)MTAVResourceRequestStatus reqStatus;        //请求状态
