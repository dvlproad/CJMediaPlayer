...
@implementation CJAVResourceInfo
...
- (void)commonInit {
    ...
    self.status         = CJAVResourceInfoStatus_None;
...
- (id)copyWithZone:(NSZone *)zone {
    ...
    CJAVResourceInfo *copy = [[[self class] allocWithZone:zone] init];
